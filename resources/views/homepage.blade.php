...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">For more inquires Contact our Official Number: 09485554255</h2>
                    <h3 class="section-heading text-uppercase">Address: Purok 10, Los Angeles, Butuan City</h3
                </div>
            </div>
            <center>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; BAFMPC 2023</div>
